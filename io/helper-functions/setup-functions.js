...
const cardFunctions = require("./card-functions").cardFunctions;
const fs = require("fs");
...
const gameSetup = {
  ...
  initializeDecks: function (roomId) {
    const room = rooms[roomId - 1];
    cardFunctions.setDeck(room.decks, "hold");
    cardFunctions.setDeck(room.decks, "holdDiscard");
